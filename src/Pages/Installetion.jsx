...
const Installation = () => {
  ...
  return (
    <div className="bg-[#D2D2D2] h-screen">
      <div className="text-center py-8 lg:py-10 space-y-2 lg:space-y-3 px-4">
        <h1 className="font-bold text-3xl lg:text-5xl">Your Installed Apps</h1>
        <p className="text-base lg:text-xl">Explore All Trending Apps on the Market developed by us</p>
      </div>

      {/* controls */}
      <div className="container mx-auto px-4 flex flex-col lg:flex-row gap-3 lg:gap-0 lg:justify-between lg:items-center py-3">
        <h1 className="font-semibold text-xl lg:text-2xl">
          <span>({sortedItem.length}) Apps Found</span>
        </h1>

        <select
          className="select select-bordered rounded w-full lg:w-auto"
          value={sortApps}
      ...
      <div className="space-y-3 px-4">
        {sortedItem.map(a => (
          <div key={a.id} className="container mx-auto bg-base-100 shadow-sm p-2 rounded">
            <div className="card card-side">
              <div className="flex flex-col lg:flex-row w-full lg:items-center justify-between p-4">
                {/* left */}
                <div className="flex items-start lg:items-center gap-4">
                  <img src={a.image} alt={a.title} className="w-[80px] h-[80px] object-cover rounded" />
                  <div className="flex flex-col">
                    <h2 className="card-title font-semibold text-lg lg:text-xl">{a.title}</h2>
                ...
                <div className="mt-3 lg:mt-0 lg:shrink-0">
                  <button
                    ...
                    className="btn w-full lg:w-auto text-white bg-[#00D390]"
                  >
                    Uninstall
                  </button>
                </div>
